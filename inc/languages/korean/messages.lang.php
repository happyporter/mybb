...
$l['error_nopermission_guest_1'] = "아래 사유로 인해 접근이 제한되었습니다. 해당 사항이 있는지 확인 후 문제를 해결하세요";
$l['error_nopermission_guest_2'] = "로그인 하지 않았거나 회원 가입을 하지 않았습니다. 로그인이 필요한 경우 아래 양식을 이용해 로그인하세요.";
$l['error_nopermission_guest_3'] = "이 페이지에 대한 접근 권한이 없습니다. 허용되지 않은 리소스에 접근하고 있는지 확인하세요.";
$l['error_nopermission_guest_4'] = "관리자에 의해 계정이 비활성화 되었거나 가입 승인 대기 중일 수 있습니다.";
$l['error_nopermission_guest_5'] = "정상적인 경로를 통하지 않고 이 페이지에 직접 접속을 시도한 경우 접근이 제한될 수 있습니다.";
$l['login'] = "로그인";
$l['need_reg'] = "회원 가입";
$l['forgot_password'] = "비밀번호 찾기";
...
$l['please_correct_errors'] = "아래 오류를 확인 후 계속하세요:";
